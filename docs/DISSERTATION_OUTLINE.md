...
- **CG-VAE identified factors** (passing MCC threshold): Tier 1b anchor — correspondence with true generative factors via Kong et al. (2025) Theorem 2; features in the PH $\cap$ CG-VAE joint component occupy the doubly-Level-1 Tier 1-joint (§14.6)
